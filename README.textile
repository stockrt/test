...
You should be running load/performance tests in parallel with another tool. From time to time, say 10 seconds, the latency.rb tool checks the time Nginx Push Stream is taking to deliver one particular timestamped message. With that you can verify if your delivery time is according to your needs even under load.
