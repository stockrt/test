...
* Version number size
** Size is like this:
*** 1 would be a version number like from 0.1 to 1.9
*** 2 would be a version number like from 0.1 to 1.99
*** 3 would be a version number like from 0.1 to 1.999
...
See "LICENSE":https://github.com/stockrt/test/blob/master/LICENSE
